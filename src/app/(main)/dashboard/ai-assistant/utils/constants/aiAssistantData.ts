...
export const INITIAL_MESSAGE: IChatMessage = {
  id: "welcome-1",
  type: "assistant",
  content: "Hello! I'm your AI financial assistant. I can help you analyze spending patterns, optimize your budget, track goals, and provide personalized financial insights. I can also help you create transactions, set up goals, add accounts, and manage budgets. How can I help you today?",
  timestamp: new Date(),
};
...
export const QUICK_PROMPTS: IQuickPrompt[] = [
  ...
  {
    id: "savings-goal",
    text: "Help me reach my savings goal",
    icon: "🎯",
    color: "green",
  },
  {
    id: "unusual-transactions",
    text: "Review unusual transactions",
    icon: "🔍",
    color: "orange",
  },
];
...
export const AI_INSIGHTS: IInsightCard[] = [
  ...
  },
  {
    ...
    type: "progress",
    title: "Goal Progress",
    description: "You're on track to reach your vacation fund goal 2 months early",
    icon: "🎯",
    color: "green",
...
export const SAMPLE_MESSAGES: IChatMessage[] = [
  INITIAL_MESSAGE,
];
