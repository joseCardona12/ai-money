...
import { SignUpStatus } from "../hooks/useSignUpModal";

interface ISignUpStatusModalProps {
  isOpen: boolean;
  status: SignUpStatus;
  message?: string;
  onClose?: () => void;
...
export default function SignUpStatusModal({
  isOpen,
  status,
  message,
  onClose,
}: ISignUpStatusModalProps): React.ReactNode {
