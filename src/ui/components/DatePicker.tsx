    ...
    <div className={`relative ${className}`} ref={datePickerRef}>
      ...
      <button
        ...
        className={`
          ...
          ${isOpen ? "border-[var(--color-blue)] ring-2 ring-[var(--color-blue)]" : ""}
        `}
        style={{ backgroundColor: "var(--color-white)" }}
      >
        <div className="flex items-center justify-between">
          <span style={{ color: selectedDate ? "var(--color-text-black)" : "var(--color-text-gray)" }}>
      ...
      {isOpen && (
        <div
          className="absolute z-50 w-full mt-1 bg-white border border-[var(--color-gray-border)] rounded-lg shadow-lg p-4"
          style={{ backgroundColor: "var(--color-white)" }}
        >
          {/* Month Navigation */}
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <IconChevronLeft size={16} className="text-[var(--color-text-gray)]" />
            </button>
            ...
            <button
              ...
              className="p-1 hover:bg-[var(--color-gray-light)] rounded transition-colors"
            >
              <IconChevronRight size={16} className="text-[var(--color-text-gray)]" />
            </button>
          </div>
          ...
          <div className="grid grid-cols-7 gap-1 mb-2">
            {dayNames.map(day => (
              <div key={day} className="text-xs font-medium text-[var(--color-text-gray)] text-center py-1">
                {day}
              </div>
            ))}
          </div>
